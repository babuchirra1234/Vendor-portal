    ...
    export class VendorAttachments extends Component {
     ...
     ChangeHandlerFile=e=>{
      ...
      upload= (e) => {
        ...
        axios
          ...
          .catch((error) => {
            console.log(error);
            alert("Uploading Documents failed")
          });
